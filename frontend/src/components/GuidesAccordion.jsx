...
const GUIDE_DATA = [
  {
    ...
    steps: [
      ...
      "В настройках Android для Hiddify отключи ограничения батареи (режим без ограничений), чтобы система не выгружала приложение в фоне.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Если на твоей версии iOS доступны настройки фоновой активности/энергосбережения для приложения, отключи ограничения для Hiddify.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Запускай Hiddify от имени администратора, чтобы приложение работало стабильнее с системным VPN.",
